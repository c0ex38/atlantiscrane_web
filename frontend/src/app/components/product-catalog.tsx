...
export default function ProductCatalog({ locale, products }: ProductCatalogProps) {
  ...
  const items = products
    ...
    .map((product) => ({
      ...
      shortIntro: product.shortIntro?.[locale] || "",
      description: product.description?.[locale] || "",
      capacity: product.capacity?.[locale] || "",
      outreach: product.outreach?.[locale] || "",
    }));
